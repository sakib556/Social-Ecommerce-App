...
class BookRentOfferScreen extends ConsumerStatefulWidget {
  final BookModel bookModel;
  const BookRentOfferScreen({
    Key? key,
    required this.bookModel,
  }) : super(key: key);

  @override
  ConsumerState<BookRentOfferScreen> createState() => _BookRentOfferScreenState();
}

class _BookRentOfferScreenState extends ConsumerState<BookRentOfferScreen> {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SpaceHorizontal(10),
                    Text(
                      widget.bookModel.costPerExtraDay.isNotEmpty
                          ? widget.bookModel.costPerExtraDay
                          : widget.bookModel.costFirstDay,
                      style: Theme.of(context).textTheme.headline6!.copyWith(
                            color: Theme.of(context)
                                .colorScheme
                  ...
                  onPressed: () async {
                    ...
                    RentUpdateInformation _updateInformation =
                        RentUpdateInformation(
                            ...
                            updateInformations: [],
                            userMessages: [],
                            costFirstDay: widget.bookModel.costFirstDay,
                            costPerExtraDay: widget.bookModel.costPerExtraDay);
                    OfferModel _offerModel = OfferModel(
                        id: _offerId,
                        buyerId: FirebaseConstants.firebaseInstance.currentUser!.uid,
                        sellerId: widget.bookModel.userId,
                        listingId: widget.bookModel.id,
                        rentUpdateInformation: _updateInformation,
...
class BookSellOfferScreen extends ConsumerStatefulWidget {
  final BookModel bookModel;
  final bool forRent;
  const BookSellOfferScreen({
    Key? key,
  ...
  @override
  ConsumerState<BookSellOfferScreen> createState() =>
      _BookSellOfferScreenState();
}

class _BookSellOfferScreenState extends ConsumerState<BookSellOfferScreen> {
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              const SpaceHorizontal(10),
                              Text(DateFormatter.toTime(_pickupTime??DateTime.now()),
                                  style: Theme.of(context)
                                      .textTheme
                                      .headline6!
                                      .copyWith(
                  ...
                  onPressed: () async {
                    ...
                    SellUpdateInformation _updateInformation =
                        SellUpdateInformation(
                            cost: widget.bookModel.sellPrice,
                            lastUpdateTime: DateTime.now(),
                            updateInformations: [],
                            userMessages: []);
                    OfferModel _offerModel = OfferModel(
