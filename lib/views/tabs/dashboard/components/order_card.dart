                          ...
                          child: GestureDetector(
                            onTap: (() {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      OrderDetailsPage(offerModel: offerModel,orderModel: orderModel,),
                                ),
                              );
                            }),
                            child: SizedBox(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          OrderTitle(listing: listing.first),
...
class OrderTitle extends StatelessWidget {
  const OrderTitle({Key? key, required this.listing}) : super(key: key);
